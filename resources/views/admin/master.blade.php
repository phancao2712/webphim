...
<head>
    <title>Glance Design Dashboard an Admin Panel Category Flat Bootstrap Responsive Website Template | Inbox ::
        w3layouts</title>
...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- js-->
    <script src="{{ asset('admin/js/jquery-1.11.1.min.j') }}s"></script>
                ...
                <div class="col-md-8 compose-right widget-shadow">
                    <div class="panel-default">
                        ...
                        <div class="inbox-page">
                            ...
                            <div class="inbox-row widget-shadow" id="accordion1" role="tablist"
                                aria-multiselectable="true">
                                <div class="mail "> <input type="checkbox" class="checkbox"> </div>
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a
                                            bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt
                        ...
                        <div class="inbox-page row">
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <div id="collapseFive" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry
                                            richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard
                                            dolor brunch Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid
                                            single-origin coffee nulla assumenda shoreditch Nihil.</p>
                                        <form>
                                            <input type="text" placeholder="Reply to sender" required="">
                                            <input type="submit" value="Send">
                                        </form>
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <div id="collapseSix" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
                                            nesciunt laborum eiusmod. Brunch 3 wolf moon tempor assumenda shoreditch et.
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                    href="#collapseSev" aria-expanded="true" aria-controls="collapsesev">
                                    <div class="mail">
                                ...
                                <div class="mail-right dots_drop">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu float-right">
                                            <li>
                                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                    href="#collapseSev" aria-expanded="true"
                                ...
                                <div class="clearfix"> </div>
                                <div id="collapseSev" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="headingsev">
                                    <div class="mail-body">
                                        <p>wolf moon officia aute, non cupidatat skateboard dolor brunch aliqua put a
                                            bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil
                                            anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt
                                            sapiente ea proident.</p>
                                        <form>
                        ...
                        <div class="inbox-page row">
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <div id="collapseNine" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <div id="collapse11" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <div id="collapse12" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Anim pariatur cliche repreh enderit brunch 3 wolf moon tempor, sunt aliqua
                                ...
                                <div id="collapse16" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry
                                            richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard
                                            dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon
                                            tempor, sunt aliqua putica sapiente ea proident.</p>
                                        <form>
                                            <input type="text" placeholder="Reply to sender" required="">
                                            <input type="submit" value="Send">
                                        </form>
                            ...
                            <div class="inbox-row widget-shadow">
                                ...
                                <div id="collapse18" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="mail-body">
                                        <p>Laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua coffee nulla
                                            assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore
                                            wes anderson cred nesciunt sapiente ea proident.</p>
                                        <form>
                                            <input type="text" placeholder="Reply to sender" required="">
